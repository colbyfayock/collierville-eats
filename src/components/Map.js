...
const Map = ({ children, center = [0, 0], zoom = 4 }, ref) => {
  if ( !isDomAvailable ) {
    return (
  ...
  return (
    <div className={mapStyles.map}>
      <BaseMap {...mapSettings}>
        <TileLayer name="OpenStreetMap" url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" attribution="&copy; <a href=&quot;https://www.openstreetmap.org/copyright&quot;>OpenStreetMap</a> contributors" />
